                ...
                <table class="table table-bordered table-striped mb-0">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>Location
                                <a href="?pending_sort=location&order=<?= $sortColumn === 'location' && strtolower($sortOrder) === 'asc' ? 'desc' : 'asc' ?>">
                                    <img src="../SVG/sort-<?= $sortColumn === 'location' && strtolower($sortOrder) === 'asc' ? 'up' : 'down' ?>.svg" alt="<?= $sortOrder === 'asc' ? 'Ascending' : 'Descending' ?>" width="16" height="16">
                                </a>
                            </th>
                            <th>Duration 
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                if ($eventDetails !== false) {
                                                    ...
                                                    <p>location: <?= htmlspecialchars($eventDetails['location']); ?></p>
                ...
                <table class="table table-bordered table-striped mb-0">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>location 
                                <a href="?ongoing_sort=location&order=<?= $sortColumnOngoing === 'location' && strtolower($sortOrderOngoing) === 'asc' ? 'desc' : 'asc' ?>">
                                    <img src="../SVG/sort-<?= $sortColumnOngoing === 'location' && strtolower($sortOrderOngoing) === 'asc' ? 'up' : 'down' ?>.svg" alt="<?= $sortOrderOngoing === 'asc' ? 'Ascending' : 'Descending' ?>" width="16" height="16">
                                </a>
                            </th>
                            <th>Duration 
            ...
            if ($totalApprovedEvents > 0) {
                ...
                <table class="table table-bordered table-striped mb-0">
                    ...
                    <tr>
                        ...
                        <th>location 
                            <a href="?approved_sort=location&order=<?= $sortColumnApproved === 'location' && strtolower($sortOrderApproved) === 'asc' ? 'desc' : 'asc' ?>">
                                <img src="../SVG/sort-<?= $sortColumnApproved === 'location' && strtolower($sortOrderApproved) === 'asc' ? 'up' : 'down' ?>.svg" alt="<?= $sortOrderApproved === 'asc' ? 'Ascending' : 'Descending' ?>" width="16" height="16">
                            </a>
                        </th>
                        <th>Duration 
            ...
            if ($totalCompletedEvents > 0) {
                ...
                <table class="table table-bordered table-striped mb-0">
                    ...
                    <tr>
                        ...
                        <th>location 
                            <a href="?completed_sort=location&order=<?= $sortColumnCompleted === 'location' && strtolower($sortOrderCompleted) === 'asc' ? 'desc' : 'asc' ?>">
                                <img src="../SVG/sort-<?= $sortColumnCompleted === 'location' && strtolower($sortOrderCompleted) === 'asc' ? 'up' : 'down' ?>.svg" alt="<?= $sortOrderCompleted === 'asc' ? 'Ascending' : 'Descending' ?>" width="16" height="16">
                            </a>
                        </th>
                        <th>Duration 
            ...
            if ($totalDeniedEvents > 0) {
                ...
                <table class="table table-bordered table-striped mb-0">
                    ...
                    <tr>
                        ...
                        <th>location 
                            <a href="?denied_sort=location&order=<?= $sortColumnDenied === 'location' && strtolower($sortOrderDenied) === 'asc' ? 'desc' : 'asc' ?>">
                                <img src="../SVG/sort-<?= $sortColumnDenied === 'location' && strtolower($sortOrderDenied) === 'asc' ? 'up' : 'down' ?>.svg" alt="<?= $sortOrderDenied === 'asc' ? 'Ascending' : 'Descending' ?>" width="16" height="16">
                            </a>
                        </th>
                        <th>Duration 
        ...
        searchInput.addEventListener('input', function () {
            ...
            sections.forEach(section => {
                ...
                tableRows.forEach(row => {
                    ...
                    if (title.includes(searchTerm) || description.includes(searchTerm) || location.includes(searchTerm) || duration.includes(searchTerm) || dateRequested.includes(searchTerm)) {
                        row.style.display = '';
                        hasVisibleRows = true;
                    } else {
